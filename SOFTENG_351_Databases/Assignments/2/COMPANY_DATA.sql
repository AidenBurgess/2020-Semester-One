...
UPDATE DEPARTMENT 
SET Mgr_ssn = "333445555", Mgr_start_date = "1978-05-22" 
WHERE Dnumber =5;

UPDATE DEPARTMENT 
SET Mgr_ssn = "987654321", Mgr_start_date = "1985-01-01" 
WHERE Dnumber =4;

UPDATE DEPARTMENT 
SET Mgr_ssn = "888665555", Mgr_start_date = "1971-06-19" 
WHERE Dnumber =1;

UPDATE DEPARTMENT 
SET Mgr_ssn = "111111100", Mgr_start_date = "1999-05-15" 
WHERE Dnumber =6;

UPDATE DEPARTMENT 
SET Mgr_ssn = "444444400", Mgr_start_date = "1998-05-15" 
WHERE Dnumber =7;

UPDATE DEPARTMENT 
SET Mgr_ssn = "555555500", Mgr_start_date = "1997-01-01" 
WHERE Dnumber =8;
